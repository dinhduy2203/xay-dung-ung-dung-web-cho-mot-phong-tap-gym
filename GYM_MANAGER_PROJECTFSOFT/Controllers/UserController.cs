...
namespace GYM_MANAGER_PROJECTFSOFT.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult ProfileUser(ProfileDetail profileDetail, FormCollection form)
        {
            ...
            Profile profile = db.Profile.SingleOrDefault(x => x.MaTaiKhoan == profileDetail.MaTaiKhoan);
            if(profile != null)
            {
        ...
        public ActionResult UploadAvatar(HttpPostedFileBase file, int MaTaiKhoan)
        {
            ...
            try
            {
                if (file.ContentLength > 0)
                {
                    ...
                    file.SaveAs(_path);
                    var profileAvatar = db.Profile.SingleOrDefault(x => x.MaTaiKhoan == mataikhoan);
        ...
        public ActionResult CreateMemberCard(int? MaTaiKhoan)
        {
            ...
            int mataikhoan = (int)MaTaiKhoan;
            LOAITHETHANHVIEN loaithetv = db.LOAITHETHANHVIEN.SingleOrDefault(x => x.MaLoaiTheThanhVien == 1);
        ...
        public ActionResult CreateMemberCard(TheThanhVienDetail thethanhviendetail)
        {
            ...
            db.THETHANHVIEN.Add(thethanhvien);
            db.SaveChanges();
            ...
            Profile profile = db.Profile.SingleOrDefault(x => x.MaTaiKhoan == thethanhviendetail.MaTaiKhoan);
        ...
        public Model1GroupTheThanhVien DisplayMemberCard(int? MaTaiKhoan)
        {
            ...
            THANHVIEN thanhvien = db.THANHVIEN.SingleOrDefault(x => x.MaThanhVien == profile.MaThanhVien);
            if (thanhvien != null)
            {
                THETHANHVIEN thethanhvien = db.THETHANHVIEN.SingleOrDefault(x => x.MaTheThanhVien == thanhvien.MaTheThanhVien);
                    LOAITHETHANHVIEN loaithethanhvien = db.LOAITHETHANHVIEN.SingleOrDefault(x => x.MaLoaiTheThanhVien == thethanhvien.MaLoaiTheThanhVien);
